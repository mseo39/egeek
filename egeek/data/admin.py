...
from data.models import Uploadfile, dorm1_data, dorm2_data, dorm3_data, manager, old_dorm1_data,old_dorm2_data,old_dorm3_data,global_dorm_data, overnight_stay, overnight_list
